...
posts0.2 <- read_csv("./data/out.csv") # dataset scraped from html files (data_no_video.tar.gz)
...
data17 <- inner_join(big_posts07, big_meta01) 
...
# randomly selected 5% of the data set for pre-analysis
